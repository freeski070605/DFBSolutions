            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="text-[0.62rem] font-black uppercase tracking-[0.2em] text-signal">
                  {index % 3 === 0 ? "Prototype" : index % 3 === 1 ? "Testing" : "In Progress"}
                </span>
              </div>
              ...
              <p className="mt-4 text-sm leading-6 text-slate-400">
                Blueprint mode: mapping the next version, pressure-testing the
                concept, and shaping the asset system around it.
              </p>
            </motion.article>
          ))}
        </div>
